...
const ToggleButton = () => {
    ...
    return (
        <div onClick={buttonHandler} ref={buttonContainerRef} className={`${!dark ? 'bg-white border-yellow-400' : 'bg-black border-gray-500'} p-1 md:w-[100px] rounded-full flex justify-end border-2 border-solid`}>
