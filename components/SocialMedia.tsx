...
const SocialMedia = (prop: { size: number }) => {
    return (
        <div className="flex items-center justify-between my-4 w-full sm:w-4/5">
            <Link target='_blank' href={"https://www.linkedin.com/in/mahanasadi/"} className="rounded-full shadow-lg shadow-gray-400 p-3 cursor-pointer hover:scale-150 hover:bg-violet-300 ease-in duration-300">
