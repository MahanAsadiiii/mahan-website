        ...
        <Layout idName='projects'>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 pt-10 mx-4">
                {ProjectDetails.map((project, index) => {
                    return (
                        <div key={index} className="relative flex items-center justify-center shadow-xl shadow-gray-400 rounded-xl group hover:bg-gradient-to-r from-violet-500 to-violet-300 h-80 hover:scale-105 ease-in-out duration-300 px-2 py-3 max-h-64 ">
                            <Image src={project.imageName} height={160} alt='skills-logo' className='rounded-md group-hover:opacity-5' />
