        ...
        <div className="flex justify-between basis-2/5 gap-5">
            ...
            <div className="flex flex-col justify-between gap-10 basis-[95%] py-4">
                <div className="flex flex-col md:w-1/2 gap-3 group">
                    <div className="md:group-hover:-translate-x-60 md:group-hover:scale-105 ease-in-out duration-500 group-hover:p-5 rounded-xl group-hover:shadow-2xl flex flex-col gap-2 group-hover:gap-4 group-hover:bg-[#5651e5d8] group-hover:text-white">
