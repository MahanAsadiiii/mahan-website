...
const Main = () => {
    return (
        <Layout idName={'home'}>
            <div className='w-full mx-auto flex flex-col md:flex-row md:items-center  justify-between gap-14 lg:py-16 py-8 cursor-default'>
                ...
                <div className="flex justify-center basis-1/2">
                    <Image src={heroGif} alt='intro-pic' />
                </div>
            </div>
        </Layout>
    )
