        ...
        <Layout idName={'home'}>
            <div className='w-full mx-auto flex flex-col md:flex-row md:items-center  justify-between gap-14  cursor-default'>
                <div className="flex flex-col items-center basis-1/2 gap-5 lg:gap-8 ">
                    ...
                    <Link href="file/MahanAsadi-cv.pdf" className='lg:w-3/5'><button className='py-3 px-16 rounded-md mt-4 hover:scale-110 w-full ease-in-out duration-500'>دانلود رزومه</button></Link>
                </div>
